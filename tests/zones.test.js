...
test('tickFillColor — same banding scaled to 0..1', () => {
  assert.strictEqual(tickFillColor(0.0), 'var(--bms-red)');
  assert.strictEqual(tickFillColor(0.19), 'var(--bms-red)');
  assert.strictEqual(tickFillColor(0.2), 'var(--bms-amber)');
  assert.strictEqual(tickFillColor(0.39), 'var(--bms-amber)');
  assert.strictEqual(tickFillColor(0.4), 'var(--bms-cyan)');
  assert.strictEqual(tickFillColor(0.69), 'var(--bms-cyan)');
  assert.strictEqual(tickFillColor(0.7), 'var(--bms-green)');
  assert.strictEqual(tickFillColor(1.0), 'var(--bms-green)');
});
