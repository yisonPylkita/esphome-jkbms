...
const T = {
  pl: {
    ...
    'alarm.adv.quiet.desc':   'ile minut zamkniętych drzwi i braku ruchu jest wymagane przed auto-uzbrojeniem',
    'alarm.adv.grace.name':   'karencja po uzbrojeniu (s)',
    'alarm.adv.grace.desc':   'ile sekund po uzbrojeniu czujniki są ignorowane (czas na opuszczenie pomieszczenia)',
    'alarm.adv.siren.name':   'czas trwania syreny (s)',
    'alarm.adv.siren.desc':   'jak długo dzwoni syrena po wyzwoleniu; stan alarmu pozostaje aktywny aż do rozbrojenia',
    ...
    'buildstamp.title': 'Identyfikator wersji panelu (porównaj z `sha256sum {0}` lokalnie, aby zweryfikować wdrożenie)',
  },
  ...
  en: {
    ...
    'alarm.adv.grace.desc':   'seconds after arming during which sensors are ignored (time to leave the room)',
    'alarm.adv.siren.name':   'siren duration (s)',
    'alarm.adv.siren.desc':   'how long the siren rings after a trip; alarm state stays latched until disarmed',
