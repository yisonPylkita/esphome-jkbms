...
function stepAlarm(ctx) {
  ...
  switch (state) {
    case 'disarmed': {
      ...
      // (door closed + no motion) for one tick, start the arming
      // countdown. Manual arm (UI button) sets state directly so doesn't
      // need a branch here.
