...
// `$` ships from lib/dom.js. `pad()` is a 2-char zero-pad used by the
// change-feed / polling-status rows further down; kept local because
// it's the only file that needs it.
